    ...
    <div className='bg-brand-light text-brand-dark font-body px-6 py-20 space-y-24'>
      ...
      <section className='text-center max-w-3xl mx-auto'>
        ...
        <p className='text-neutral-700 mt-4'>
          Whether it’s brunch, birthdays, or board meetings, we bring the handmade abundance.
          Nothing store-bought. Nothing ordinary. Just delight, drama, and a damn good bite.
        </p>
      </section>
      ...
      <section className='max-w-4xl mx-auto text-center space-y-4'>
        ...
        <ul className='grid gap-6 sm:grid-cols-2 md:grid-cols-3'>
          {boardOptions.map((board) => (
            <li
              key={board.name}
              className='bg-white p-6 rounded-xl shadow-card border border-brand-buttercream text-left'>
              <h3 className='text-lg font-semibold text-brand-rosewood'>{board.name}</h3>
        ...
        <p className='text-xs text-neutral-600'>
          Want it boxed instead of board-style? Just ask — we’ve got options.
        </p>
      </section>

      <section className='max-w-3xl mx-auto text-center space-y-4'>
        <h2 className='text-2xl font-display text-brand-rosewood font-semibold'>What’s Included</h2>
